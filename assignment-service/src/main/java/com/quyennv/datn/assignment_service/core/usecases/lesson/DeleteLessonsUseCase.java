...
public class DeleteLessonsUseCase extends CourseUpdateUseCase {
    public DeleteLessonsUseCase(CourseRepository courseRepository) {
    ...
    protected Course update(Course course, InputValues input) {
        ...
        return course.deleteLessons(lessons, input.getSectionId());
    }
}
