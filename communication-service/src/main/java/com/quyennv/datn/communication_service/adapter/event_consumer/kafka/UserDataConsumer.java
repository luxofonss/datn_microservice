package com.quyennv.datn.communication_service.adapter.event_consumer.kafka;

import com.quyennv.datn.communication_service.adapter.event_consumer.kafka.cdc.MessageCDC;
import com.quyennv.datn.communication_service.adapter.event_consumer.kafka.cdc.user.UserAfter;
import com.quyennv.datn.communication_service.adapter.event_consumer.kafka.cdc.user.UserRepository;
...
import com.quyennv.datn.communication_service.presenter.utils.DateHelper;
import com.quyennv.datn.communication_service.presenter.utils.JsonHelper;
...
public class UserDataConsumer {
    ...
    @KafkaListener (
            topics = "users_communication.public.users",
            groupId = "users_communication-group",
